...
const _marketListings = [
  { id: 'l-1',  item: { id: 'i-1',  name: 'AK-47 | Redline',                rarity: 'Classified',   exterior: 'Field-Tested',   imageUrl: mockImg('classified',  'AK-47 | Redline'),                prices: [{ price: 12.45  }] } },
  { id: 'l-2',  item: { id: 'i-2',  name: 'AWP | Asiimov',                  rarity: 'Covert',        exterior: 'Field-Tested',   imageUrl: mockImg('covert',      'AWP | Asiimov'),                  prices: [{ price: 67.30  }] } },
  { id: 'l-3',  item: { id: 'i-3',  name: 'M4A4 | Howl',                    rarity: 'Contraband',    exterior: 'Minimal Wear',   imageUrl: mockImg('contraband',  'M4A4 | Howl'),                    prices: [{ price: 1850.00}] } },
  { id: 'l-4',  item: { id: 'i-4',  name: 'Glock-18 | Fade',                rarity: 'Restricted',    exterior: 'Factory New',    imageUrl: mockImg('restricted',  'Glock-18 | Fade'),                prices: [{ price: 220.00 }] } },
  { id: 'l-5',  item: { id: 'i-5',  name: 'Desert Eagle | Blaze',           rarity: 'Restricted',    exterior: 'Factory New',    imageUrl: mockImg('restricted',  'Desert Eagle | Blaze'),           prices: [{ price: 78.50  }] } },
  { id: 'l-6',  item: { id: 'i-6',  name: 'USP-S | Kill Confirmed',         rarity: 'Covert',        exterior: 'Minimal Wear',   imageUrl: mockImg('covert',      'USP-S | Kill Confirmed'),         prices: [{ price: 45.20  }] } },
  { id: 'l-7',  item: { id: 'i-7',  name: 'Karambit | Doppler',             rarity: 'Covert',        exterior: 'Factory New',    imageUrl: mockImg('covert',      'Karambit | Doppler'),             prices: [{ price: 560.00 }] } },
  { id: 'l-8',  item: { id: 'i-8',  name: 'FAMAS | Afterimage',             rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'FAMAS | Afterimage'),             prices: [{ price: 5.80   }] } },
  { id: 'l-9',  item: { id: 'i-9',  name: 'M4A1-S | Hyper Beast',          rarity: 'Covert',        exterior: 'Field-Tested',   imageUrl: mockImg('covert',      'M4A1-S | Hyper Beast'),           prices: [{ price: 32.00  }] } },
  { id: 'l-10', item: { id: 'i-10', name: 'AK-47 | Case Hardened',          rarity: 'Classified',    exterior: 'Battle-Scarred', imageUrl: mockImg('classified',  'AK-47 | Case Hardened'),          prices: [{ price: 18.90  }] } },
  { id: 'l-11', item: { id: 'i-11', name: 'P250 | Asiimov',                 rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'P250 | Asiimov'),                 prices: [{ price: 11.40  }] } },
  { id: 'l-12', item: { id: 'i-12', name: 'Butterfly Knife | Tiger Tooth',  rarity: 'Covert',        exterior: 'Factory New',    imageUrl: mockImg('covert',      'Butterfly Knife | Tiger Tooth'),  prices: [{ price: 430.00 }] } },
  { id: 'l-13', item: { id: 'i-13', name: 'SSG 08 | Blood in the Water',    rarity: 'Covert',        exterior: 'Factory New',    imageUrl: mockImg('covert',      'SSG 08 | Blood in the Water'),    prices: [{ price: 148.00 }] } },
  { id: 'l-14', item: { id: 'i-14', name: 'Glock-18 | Water Elemental',     rarity: 'Restricted',    exterior: 'Field-Tested',   imageUrl: mockImg('restricted',  'Glock-18 | Water Elemental'),     prices: [{ price: 6.20   }] } },
  { id: 'l-15', item: { id: 'i-15', name: 'M4A4 | Desolate Space',          rarity: 'Classified',    exterior: 'Minimal Wear',   imageUrl: mockImg('classified',  'M4A4 | Desolate Space'),          prices: [{ price: 9.70   }] } },
  { id: 'l-16', item: { id: 'i-16', name: 'AUG | Chameleon',                rarity: 'Mil-Spec Grade',exterior: 'Factory New',    imageUrl: mockImg('milspec',     'AUG | Chameleon'),                prices: [{ price: 1.20   }] } },
  { id: 'l-17', item: { id: 'i-17', name: 'AWP | Electric Hive',            rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'AWP | Electric Hive'),            prices: [{ price: 19.50  }] } },
  { id: 'l-18', item: { id: 'i-18', name: 'MP9 | Hot Rod',                  rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'MP9 | Hot Rod'),                  prices: [{ price: 52.00  }] } },
  { id: 'l-19', item: { id: 'i-19', name: 'P90 | Asiimov',                  rarity: 'Classified',    exterior: 'Field-Tested',   imageUrl: mockImg('classified',  'P90 | Asiimov'),                  prices: [{ price: 14.80  }] } },
  { id: 'l-20', item: { id: 'i-20', name: 'Five-SeveN | Monkey Business',   rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'Five-SeveN | Monkey Business'),   prices: [{ price: 7.30   }] } },
  { id: 'l-21', item: { id: 'i-21', name: 'USP-S | Orion',                  rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'USP-S | Orion'),                  prices: [{ price: 28.00  }] } },
  { id: 'l-22', item: { id: 'i-22', name: 'AK-47 | Fire Serpent',           rarity: 'Covert',        exterior: 'Field-Tested',   imageUrl: mockImg('covert',      'AK-47 | Fire Serpent'),           prices: [{ price: 390.00 }] } },
  { id: 'l-23', item: { id: 'i-23', name: 'Nova | Antique',                 rarity: 'Consumer Grade',exterior: 'Factory New',    imageUrl: mockImg('consumer',    'Nova | Antique'),                 prices: [{ price: 0.45   }] } },
  { id: 'l-24', item: { id: 'i-24', name: 'SG 553 | Integrale',             rarity: 'Classified',    exterior: 'Factory New',    imageUrl: mockImg('classified',  'SG 553 | Integrale'),             prices: [{ price: 23.10  }] } },
];
